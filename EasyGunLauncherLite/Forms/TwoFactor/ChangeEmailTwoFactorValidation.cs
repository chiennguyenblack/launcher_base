...
{
    public partial class ChangeEmailTwoFactorValidation : Form
    {
        public string username;
        public string token;
        
        int countdown = 120; //seconds
        public ChangeEmailTwoFactorValidation()
        {
            InitializeComponent();
        }
        ...
        {
            timer1.Start();
            Text = this.username + ": Đổi email - Xác thực 2 lớp";
        }
        ...
        private string validate(string code)
        {
            ...
            data.code = code;
            Task<string> t = AsyncRequest.createRequestAsync("api/lite/changeEmail/validatetfa", this.token, JsonConvert.SerializeObject(data));
            ...
            {
                Log.AddLog("api/lite/changeEmail/validatetfa: " + responseString);
                MessageBox.Show("Hệ thống gặp lỗi, vui lòng thử lại hoặc liên hệ quản trị viên để được hỗ trợ! (361)", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            Close();
        ...
        /// </summary>
        public event EventHandler ChangeSuccess;
        /// <summary>
