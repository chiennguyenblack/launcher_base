...
{
    public partial class ForgotPasswordTwoFactorValidation : Form
    {
        public string account;
        
        int countdown = 120; //seconds
        public ForgotPasswordTwoFactorValidation()
        {
            InitializeComponent();
        }
        ...
        private void displayText()
        {
            ...
            string answer = string.Format("{0:D2}:{1:D2}",
                t.Minutes, 
                t.Seconds);
            label1.Text = "Nhập mã xác thực được gửi tới " + account + " (" + answer + ")";
        }
        ...
        private string validate(string code)
        {
            ...
            data.code = code;
            Task<string> t = AsyncRequest.createRequestAsync("api/lite/forgotPassword/validate", null, JsonConvert.SerializeObject(data));
            ...
            {
                Log.AddLog("api/lite/forgotPassword/validate: " + responseString);
